...
### [0. Gather Data From An API](https://github.com/MathieuMorel62/holbertonschool-back-end/blob/main/api/0-gather_data_from_an_API.py)
...
```python
mathieu@ubuntu$ python3 0-gather_data_from_an_API.py 2
...
mathieu@ubuntu$ python3 0-gather_data_from_an_API.py 4
...
mathieu@ubuntu$ python3 0-gather_data_from_an_API.py 4 | tr " " "S" | tr "\t" "T" 
Employee Patricia Lebsack is done with tasks(6/20):
...
### [1. Export To CSV](https://github.com/MathieuMorel62/holbertonschool-back-end/blob/main/api/1-export_to_CSV.py)
...
```json
mathieu@ubuntu$ python3 1-export_to_CSV.py 2
mathieu@ubuntu$ cat 2.csv
...
### [2. Export To JSON](https://github.com/MathieuMorel62/holbertonschool-back-end/blob/main/api/2-export_to_JSON.py)
...
```json
mathieu@ubuntu$ python3 2-export_to_JSON.py 2
mathieu@ubuntu$ cat 2.json
...
### [3. Dictionary Of List Of Dictionaries](https://github.com/MathieuMorel62/holbertonschool-back-end/blob/main/api/3-dictionary_of_list_of_dictionaries.py)
Using what you did in the task #0, extend your Python script to export data in the JSON format.
